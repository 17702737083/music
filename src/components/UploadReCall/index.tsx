...
} from '@/pages/hr/recruit/elc/ReNew/service';
        ...
        上传文件
            ...
            <StepsForm
                onFinish={async (values) => {
                    ...
                    await NetUtil.post(NetUtil.API.uploadReCall,values.dragger[0].originFileObj)
                    .then(data => {
                      console.log(data)
                    })
                    await waitTime(1000);
                ...
                <StepsForm.StepForm name="upload" title="上传文件">
                    ...
                    <ProForm.Group>
                        <ProFormUploadButton
                            ...
                            //action="http://192.168.66.57:8015/users/cuiqian"
                        />
                    </ProForm.Group>
